...
//                query.setInteger("NQuartos", nDormitorios);
                query.setDouble("valor", valor);
                imgs = query.list();
            } else if (valor == 0.0 & nDormitorios != 0) {
                Query query = session.createQuery("SELECT i FROM Imagens i JOIN i.idImovel JOIN i.idImovel.tipoImovel JOIN i.idImovel.endereco.cep.bairro WHERE i.idImovel.endereco.cep.bairro.id= :bairro and i.idImovel.tipoImovel.id = :tipoImovel and i.idImovel.Ndormitorios= :NQuartos and i.status = 'capa' and i.idImovel.statusImovel= 'a venda'");
                query.setLong("bairro", Bairro);
                query.setLong("tipoImovel", tipoImovel);
                query.setInteger("NQuartos", nDormitorios);
...
//                query.setInteger("NQuartos", nDormitorios);
                ...
                Query query = session.createQuery("SELECT i FROM Imagens i JOIN i.idImovel JOIN i.idImovel.tipoImovel JOIN i.idImovel.endereco.cep.bairro WHERE i.idImovel.endereco.cep.bairro.id= :bairro and i.idImovel.tipoImovel.id = :tipoImovel and i.idImovel.valorImovel <= :valor and i.idImovel.Ndormitorios= :NQuartos and i.status = 'capa' and i.idImovel.statusImovel= 'a venda'");
                query.setLong("bairro", Bairro);
                query.setLong("tipoImovel", tipoImovel);
                query.setInteger("NQuartos", nDormitorios);
                query.setDouble("valor", valor);
